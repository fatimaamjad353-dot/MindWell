...
// Remove useLanguage if it's causing issues
// import { useLanguage } from '../context/LanguageContext';

export default function RoleScreen({ navigation }) {
  // const { t } = useLanguage(); // Comment this out for now
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.cardSub}>Track your mood and wellness</Text>
      </TouchableOpacity>
      ...
      >
        ...
        <Text style={styles.cardTitle}>Psychiatrist</Text>
        <Text style={styles.cardSub}>Manage patients and sessions</Text>
      </TouchableOpacity>
