...
const patients = [
  { id: 1, name: 'Sarah M.', age: 24, sessions: 5, lastSession: 'May 5', riskScore: 7.8, riskLevel: 'high', moodTrend: '📈', issue: 'Anxiety & Depression' },
  { id: 2, name: 'Ahmed K.', age: 31, sessions: 3, lastSession: 'Apr 28', riskScore: 4.2, riskLevel: 'medium', moodTrend: '➡️', issue: 'Work Stress' },
  { id: 3, name: 'Fatima R.', age: 19, sessions: 8, lastSession: 'May 3', riskScore: 2.1, riskLevel: 'low', moodTrend: '📈', issue: 'Social Anxiety' },
  { id: 4, name: 'Omar B.', age: 27, sessions: 2, lastSession: 'Apr 20', riskScore: 6.5, riskLevel: 'medium', moodTrend: '📉', issue: 'Trauma Recovery' },
  { id: 5, name: 'Zara N.', age: 22, sessions: 6, lastSession: 'May 7', riskScore: 8.9, riskLevel: 'high', moodTrend: '📉', issue: 'Severe Depression' },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchBox}>
        ...
        <TextInput style={styles.searchInput} placeholder="Search patients..." placeholderTextColor="#aaa" value={search} onChangeText={setSearch} />
      </View>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('PsychPatientSummary', {
              patient: {
                ...
                issue: sharedSummary.recommendedSpecialties.join(', '),
              }
            })}
          >
            <View style={styles.cardTop}>
              ...
              <View style={styles.info}>
                ...
                <Text style={styles.issue}>{sharedSummary.recommendedSpecialties.join(', ')}</Text>
